...
import indi.aljet.mypreloader_master.preloader.interfaces.GroupedDataLoader;
import indi.aljet.mypreloader_master.preloader.util.ILogger;
import indi.aljet.mypreloader_master.preloader.util.PreLoaderLogger;
...
public class PreLoader {
     ...
     */
    public static <E> PreLoaderWrapper<E> just
            (DataLoader<E> loader){
     ...
     */
    public static <E> PreLoaderWrapper<E> just
    (DataLoader<E> loader,DataListener<E> listener){
        PreLoaderWrapper<E> preLoader = new PreLoaderWrapper
                <E>(loader,listener);
        preLoader.preLoad();
        return preLoader;
    }
